document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch(SHEET_URL)
        ...
        .then(csvText => {
            ...
            container.innerHTML = ''; // BORRAMOS CUALQUIER PRUEBA VIEJA
                    ...
                    if (titulo && titulo.length > 2) {
                        ...
                        card.innerHTML = `
                            ...
                            <div class="news-content">
                                ...
                                <button onclick="abrirNoticia('${titulo.replace(/'/g, "\\'")}', '${imagen}', '${categoria}', '${autor}', \`${contenido.replace(/`/g, "\\`")}\`)" 
